...
function About({ aboutRef }) {
  return (
    <SectionBorder header={`01. About`} aboutRef={aboutRef}>
      <div className='flex flex-row'>
        <div className='my-auto mx-4 text-justify w-1/2'>
          ...
          <p>
            ...
            <br />
            <br />
            When I'm not coding, you can find me traveling the world, exploring
            pour over coffee shops in the LA area, and pouring latte art!
          </p>
        </div>
